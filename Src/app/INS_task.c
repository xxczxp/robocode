...
static void IMU_rotation_solve(fp32 gyro[3], fp32 accel[3], fp32 mag[3], mpu6500_real_data_t *mpu6500, ist8310_real_data_t *ist8310);
...
//        //等待外部中断中断唤醒任务
			...
			//减去零漂以及旋转坐标系
			IMU_rotation_solve(INS_gyro, INS_accel, INS_mag, &mpu6500_real_data, &ist8310_real_data);
...
const fp32 *get_IST8310_mag_data_point(void)
{
  return INS_mag;
}
