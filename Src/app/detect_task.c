...
static void DetectInit(uint32_t time)
{
    ...
    errorList[DBUSTOE].solveLostFun = solve_RC_lost;
    errorList[DBUSTOE].solveDataErrorFun = solve_data_error;

#if GIMBAL_MOTOR_6020_CAN_LOSE_SOLVE
    errorList[YawGimbalMotorTOE].solveLostFun = GIMBAL_lose_solve;
    errorList[PitchGimbalMotorTOE].solveLostFun = GIMBAL_lose_solve;
#endif
}
