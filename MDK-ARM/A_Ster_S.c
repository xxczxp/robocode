				...
				switch(player){
					case RED : {
						if(space_A[i][j].spr == 1){
							space_A[i][j].data[0] = -11 + (field_info->castle_energy[space_A[i][j].near].energy[1] - field_info->castle_energy[space_A[i][j].near].energy[0]) / 4;
					...
					case BLUE : {
						if(space_A[i][j].spb == 1){
							space_A[i][j].data[0] = -11 + (field_info->castle_energy[space_A[i][j].near].energy[0] - field_info->castle_energy[space_A[i][j].near].energy[1]) / 4;
